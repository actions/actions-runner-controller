...
func (*RunnerDeploymentDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	// Nothing to do.
	return nil
}
...
func (*RunnerDeploymentValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	r, ok := newObj.(*RunnerDeployment)
	if !ok {
		return nil, fmt.Errorf("expected RunnerDeployment object, got %T", newObj)
	}
...
func (*RunnerDeploymentValidator) ValidateDelete(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	return nil, nil
}
