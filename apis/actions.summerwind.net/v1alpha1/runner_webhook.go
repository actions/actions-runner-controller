...
func (*RunnerValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	r, ok := newObj.(*Runner)
	if !ok {
		return nil, fmt.Errorf("expected Runner object, got %T", newObj)
	}
