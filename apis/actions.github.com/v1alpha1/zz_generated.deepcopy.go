...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EphemeralRunnerJobCompletion) DeepCopyInto(out *EphemeralRunnerJobCompletion) {
	*out = *in
	in.FinishedAt.DeepCopyInto(&out.FinishedAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EphemeralRunnerJobCompletion.
func (in *EphemeralRunnerJobCompletion) DeepCopy() *EphemeralRunnerJobCompletion {
	if in == nil {
		return nil
	}
	out := new(EphemeralRunnerJobCompletion)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EphemeralRunnerStatus) DeepCopyInto(out *EphemeralRunnerStatus) {
	*out = *in
	...
	if in.JobCompletion != nil {
		in, out := &in.JobCompletion, &out.JobCompletion
		*out = new(EphemeralRunnerJobCompletion)
		(*in).DeepCopyInto(*out)
	}
}
