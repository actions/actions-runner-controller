...
type RunnerDeploymentStatus struct {
	...
	// AvailableReplicas is the total number of available runners, that are sucessfully registetered to GitHub and still running.
	// This corresponds to the sum of status.availableReplicas of all the runner replica sets.
	// +optional
	AvailableReplicas *int `json:"availableReplicas"`

	// ReadyReplicas is the total number of available runners, that are sucessfully registetered to GitHub and still running.
