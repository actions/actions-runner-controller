...
func (in *HorizontalRunnerAutoscalerSpec) DeepCopyInto(out *HorizontalRunnerAutoscalerSpec) {
	*out = *in
	...
	if in.ScaleUpTriggers != nil {
		...
		*out = make([]ScaleUpTriggerSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScaleUpTriggerSpec) DeepCopyInto(out *ScaleUpTriggerSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScaleUpTriggerSpec.
func (in *ScaleUpTriggerSpec) DeepCopy() *ScaleUpTriggerSpec {
	if in == nil {
		return nil
	}
	out := new(ScaleUpTriggerSpec)
	in.DeepCopyInto(out)
	return out
}
