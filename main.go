...
func main() {
	...
	flag.BoolVar(&useRunnerStatusUpdateHookEphemeralRole, "use-runner-status-update-hook-emphemeral-role", false, "Use custom RBAC for runners (role, role binding and service account).")
	...
	runnerReconciler := &controllers.RunnerReconciler{
		...
		UseRunnerStatusUpdateHookEphemeralRole: useRunnerStatusUpdateHookEphemeralRole,
