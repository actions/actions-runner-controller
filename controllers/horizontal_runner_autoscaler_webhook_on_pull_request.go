...
func (autoscaler *HorizontalRunnerAutoscalerWebhook) MatchPullRequestEvent(event *github.PullRequestEvent) func(scaleUpTrigger v1alpha1.ScaleUpTriggerSpec) bool {
